...
name: adex-shared
version: 0.3.0
description: "Use when first setting up adex CLI, configuring API credentials, or needing shared flags reference (pagination, jq, date range, output format, error handling)."
metadata:
  requires:
    bins: ["adex"]
  cliHelp: "adex --help"
...
| 租户管理、当前用户信息 | [`adex-tenant-user`](../adex-tenant-user/SKILL.md) |
| 安装、配置、共享 flags 参考 | 本 Skill |
